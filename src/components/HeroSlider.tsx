...
export function HeroSlider() {
  ...
  return (
    <section className="relative h-screen min-h-[520px] sm:min-h-[600px] overflow-hidden pt-[70px] sm:pt-[80px] lg:pt-0">
      ...
      {/* CONTENT */}
      <div className="absolute inset-0 z-10 flex items-center pt-[70px] sm:pt-[80px] lg:pt-0">
        <div className="container mx-auto px-4 sm:px-5">
          <div className="max-w-3xl text-white">
            ...
            {/* Dynamic Slogan */}
            <h1 className="font-heading text-2xl sm:text-4xl md:text-5xl lg:text-6xl mb-3 sm:mb-6 leading-tight">
              {slides[current].slogan}
            </h1>

            {/* Dynamic Description */}
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white/80 mb-6 sm:mb-8 max-w-2xl transition-all duration-700 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Button
                ...
                className="btn-gold px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3 lg:py-6 text-sm sm:text-base lg:text-lg"
              >
                Request a Quote
              ...
              <Button
                ...
                className="bg-white text-navy-dark hover:bg-white/90 px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3 lg:py-6 text-sm sm:text-base lg:text-lg"
              >
                View Products
              </Button>
            </div>
          ...
          <div className="glass rounded-t-2xl py-3 sm:py-4 md:py-6 px-4 sm:px-6 md:px-8">
            <div className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-8 text-center">
              {stats.map((stat, index) => (
                <div key={index}>
                  <div className="font-heading text-base sm:text-2xl md:text-4xl font-bold text-navy-dark">
                    {stat.value}
                  </div>
